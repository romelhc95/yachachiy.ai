...
| S1.3 | **Ejecución como Usuario Root** | Media | Actualizar el `Dockerfile` para crear y usar un usuario que no sea root (ej. `yachachiy_user`). |
...
| S2.2 | **Contraseña Débil** | Alta | Cambiar la contraseña predeterminada `password_yachachiy` por un secreto fuerte generado aleatoriamente. |
